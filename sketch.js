...
function draw() {
  ...
  let customDetections = detections.filter(detected => detected.label == "person");
  document.getElementById("personas").innerHTML = "Numero total de persones es: " + customDetections.length;
}